...
d3.json("http://api.eia.gov/series/?api_key=5BDF29D557600AA90937165DE3D697D7&series_id=PET.EMM_EPMRU_PTE_NUS_DPG.W", function(error, rawData) {
  rawData = rawData["series"]["0"]["data"];
  var data = [];
